        ...
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} >
                <fieldset className="fieldset">
                    ...
                    <p className='text-sm mt-2'>Don’t have any account?<Link to='/authLayout/register' className='text-[#8FA748] font-medium'> Register</Link></p>
                    <p className='text-lg text-center my-2'>Or</p>
                    <button className="btn border-1 border-[#8FA748] mt-4">Login with Google</button>
                </fieldset>
            </form>
        </div>
    );
